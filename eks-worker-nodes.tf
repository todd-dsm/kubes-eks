...
/*
-------------------------------------------------------------------------------
Define Worker Node, Launch Configuration & AutoScaling Group
  * Fetch the latest AMI
  * That Amazon provides
  * With EKS-compatible Kubernetes baked in.
-------------------------------------------------------------------------------
*/
...
EKS currently documents this required userdata for EKS worker nodes to:
  ...
  * Utilize a Terraform local here to simplify Base64 encoding
  * This information into the AutoScaling Launch Configuration.
  REF: https://amazon-eks.s3-us-west-2.amazonaws.com/1.10.3/2018-06-05/amazon-eks-nodegroup.yaml
---------------------------------------
*/
...
---------------------------------------
AutoScaling Group
  * Launches EC2 instances based on the AutoScaling Launch Config
---------------------------------------
*/
